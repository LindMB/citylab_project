...
def generate_launch_description() :
    ...
    robot_patrol_with_service_node = Node(
        package="robot_patrol",
        executable="robot_patrol_with_service_node",
        output="screen",
        emulate_tty=True
    )

    # Direction Service Server # -> To start the service server
    ...
    return LaunchDescription([
        robot_patrol_with_service_node,
